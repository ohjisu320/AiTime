...
export const SCREENING_CONTENT: Record<string, any> = {
  ...
  "POSE_IMITATION_12M": {
    ...
    variant: 'pink',
    instructionDuration: 9, // 전체 사이클 시간: 준비 3초 + 실행 6초
    instructions: [
      {
        id: 1,
        title: "손뼉",
  ...
  "POSE_IMITATION_18M": {
    ...
    korTitle: "동작 모방",
    listTitle: "[18-23개월] 1. 점프 -> 2. 공 차기 -> 3. 공 던지기",
  ...
  "SPEECH_IMITATION_12M": {
    ...
    korTitle: "발화 모방 자극",
    listTitle: "[12-17개월] 자극: 아, 마, 바, 맘마, 까꿍",
    description: "제시된 단어(아, 마, 바, 맘마, 까꿍)를 들려주고 아이가 따라 말하는지 관찰합니다.",
    variant: 'amber',
    instructionDuration: 8, // 전체 사이클 시간: 준비 3초 + 실행 5초
    instructions: [
      // 0, 8, 16, 24, 32
      { id: 1, title: "아", text: "[ 아 ] 소리를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 0, duration: 5 },
      { id: 2, title: "마", text: "[ 마 ] 소리를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 8, duration: 5 },
      { id: 3, title: "바", text: "[ 바 ] 소리를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 16, duration: 5 },
      { id: 4, title: "맘마", text: "[ 맘마 ] 단어를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 24, duration: 5 },
      { id: 5, title: "까꿍", text: "[ 까꿍 ] 단어를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 32, duration: 5 },
    ],
  ...
  "SPEECH_IMITATION_18M": {
    ...
    korTitle: "발화 모방 자극",
    listTitle: "[18-23개월] 자극: 엄마, 우유, 자동차, 까까 주세요, 야호",
    description: "제시된 단어(엄마, 우유, 자동차, 까까 주세요, 야호)를 들려주고 아이가 따라 말하는지 관찰합니다.",
    variant: 'amber',
    instructionDuration: 8, // 전체 사이클 시간: 준비 3초 + 실행 5초
    instructions: [
      // 1. 엄마
      { id: 1, title: "엄마", text: "[ 엄마 ] 단어를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 0, duration: 5 },
      { id: 2, title: "우유", text: "[ 우유 ] 단어를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 8, duration: 5 },
      { id: 3, title: "자동차", text: "[ 자동차 ] 단어를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 16, duration: 5 },
      { id: 4, title: "까까 주세요", text: "[ 까까 주세요 ] 문장을", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 24, duration: 5 },
      { id: 5, title: "야호", text: "[ 야호! ] 감탄사를", boldText: "한 번만 말하고", suffix: "5초간 기다려주세요", startAt: 32, duration: 5 },
    ],
  ...
  "NAME_NON_FACING": {
    ...
    instructions: [
      // [3, 11, 19, 27, 35, 43]
      { id: 1, title: "평소 목소리 1", text: "시야 밖(등 뒤)에서", boldText: "평소 목소리로", suffix: "이름을 불러주세요", startAt: 3, duration: 5 },
      { id: 2, title: "평소 목소리 2", text: "한번 더", boldText: "평소 목소리로", suffix: "한 번 더 불러주세요", startAt: 11, duration: 5 },
      { id: 3, title: "큰소리 1", text: "반응이 없다면", boldText: "크고 높은 톤으로", suffix: "이름을 불러주세요", startAt: 19, duration: 5 },
      { id: 4, title: "큰소리 2", text: "여전히 반응이 없다면", boldText: "크고 높은 톤으로", suffix: "다시 불러주세요", startAt: 27, duration: 5 },
      { id: 5, title: "애칭 1", text: "반응이 없다면", boldText: "애칭을 섞어", suffix: "다정한 목소리로 불러보세요", startAt: 35, duration: 5 },
      { id: 6, title: "애칭 2", text: "마지막으로", boldText: "여기봐!를 붙여서 이름을 함께", suffix: "불러보세요", startAt: 43, duration: 5 },
    ],
  ...
  "NAME_FACING": {
    ...
    instructions: [
      // [0, 8, 16]
      { id: 1, title: "호명시도1", text: "아이와 마주 본 상태에서", boldText: "이름을 부르고", suffix: "눈맞춤을 확인하세요", startAt: 0, duration: 5 },
      { id: 2, title: "호명시도2", text: "아이와 마주 본 상태에서", boldText: "이름을", suffix: "한 번 더 불러주세요", startAt: 8, duration: 5 },
      { id: 3, title: "호명시도3", text: "마지막으로", boldText: "이름을 부르고", suffix: "눈을 맞추는지 확인하세요", startAt: 16, duration: 5 },
    ],
