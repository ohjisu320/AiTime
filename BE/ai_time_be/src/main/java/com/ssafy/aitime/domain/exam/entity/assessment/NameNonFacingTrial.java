...
public class NameNonFacingTrial {
    ...
    @JoinColumn(name = "video_id", nullable = false, foreignKey = @ForeignKey(name = "fk_name_non_facing_video"))
    private Video video;
    ...
    @Builder
    public NameNonFacingTrial(Video video, Integer totalCallCount, Integer successCount, Double successRate) {
        this.video = video;
